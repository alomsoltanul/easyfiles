...
export default function PdfUnlock() {
  ...
  return (
    <div className="space-y-8">
      {!file ? (
        <div>
          <h2 className="text-lg font-bold text-slate-800 mb-4">Upload Protected PDF</h2>
          <div
        ...
        <>
          ...
          {!result && (
            <>
              ...
              <div className="border-t border-slate-100 pt-6">
                <button onClick={handleProcess} disabled={isProcessing || !password}
          ...
          {result && (
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-lg font-bold text-slate-800">PDF Unlocked!</h2>
              ...
              <button onClick={handleReset} className="w-full py-3 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-xl">Unlock Another</button>
            </div>
          )}
        </>
      )}
