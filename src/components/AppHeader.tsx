...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Edit PDF', href: '/pdf/edit', description: 'Add text, images, shapes and drawings' },
      { label: 'Page Numbers', href: '/pdf/page-numbers', description: 'Number pages with full typographic control' },
      { label: 'Crop PDF', href: '/pdf/crop', description: 'Trim margins or crop to a selected area' },
      { label: 'Organize PDF', href: '/pdf/organize', description: 'Sort, rotate, delete and insert pages' },
      { label: 'Redact PDF', href: '/pdf/redact', description: 'Permanently remove sensitive content' },
      { label: 'PDF Forms', href: '/pdf/forms', description: 'Fill forms or create fillable fields' },
      { label: 'Compare PDF', href: '/pdf/compare', description: 'Diff two versions visually and by text' },
      { label: 'Repair PDF', href: '/pdf/repair', description: 'Recover damaged or corrupt PDFs' },
      { label: 'PDF to PDF/A', href: '/pdf/to-pdfa', description: 'Convert to the ISO archival standard' },
      { label: 'PDF to Markdown', href: '/pdf/to-markdown', description: 'Convert PDF text into clean Markdown' },
      { label: 'HTML to PDF', href: '/pdf/from-html', description: 'Turn a web page or HTML into a PDF' },
    ],
  },
  {
    id: 'json',
